...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BETWEEN_HALF_OPEN, query = "SELECT m FROM Meal m " +
                "WHERE m.user.id=:user_id AND m.dateTime>=:date_time_start AND m.dateTime<:date_time_end ORDER BY m.dateTime DESC ")
})
@Entity
@Table(name = "meals")
public class Meal extends AbstractBaseEntity {
    ...
    public static final String GET_BETWEEN_HALF_OPEN = "Meal.getBetween";
