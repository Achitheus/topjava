...
public class MealsUtil {
    ...
    public static void main(String[] args) {
        List<MealTO> mealsTo = filteredByStreams(mealList, LocalTime.of(0, 0), LocalTime.of(23, 59), 2000);
        mealsTo.forEach(System.out::println);
    }

    public static List<MealTO> toTOlist(Collection<Meal> meals, int caloriesPerDay) {
